...
var AppComponent = /** @class */ (function () {
    function AppComponent(_userService, _route, _router) {
        ...
        _router.events.forEach(function (event) {
            if (event instanceof __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* NavigationStart */]) {
                ...
                console.log("La nueva ruta es ---> " + _this.rutaActual);
            }
        });
    }
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.socket.on('usuariosConectados', function (data) {
            console.log("Estos son los usuarios conectados en la web");
            console.log(data);
        });
...
module.exports = "<div class=\"col-lg-8 col-lg-offset-2\">\n    <div class=\"jumbotron\" style=\"padding:20px;\">\n        <h1 class=\"h1-strong\">{{title}}</h1>   \n        <p>Disfruta de las publicaciones de tus amigos, y comparte tu vida! :) </p>\n        <a class=\"btn btn-success btn-lg\" role=\"button\" [routerLink]=\"['/perfil', identity._id]\" *ngIf=\"identity\">\n            Mi perfil\n        </a>\n        <a class=\"btn btn-primary btn-lg\" role=\"button\" [routerLink]=\"['/timeline']\" *ngIf=\"identity\">\n            Timeline\n        </a>\n        <a class=\"btn btn-default btn-lg\" role=\"button\" [routerLink]=\"['/gente']\" *ngIf=\"identity\">\n            Gente\n        </a>\n        <div *ngIf=\"identity\">\n            <p>Empieza encontrando gente por <a href=\"javascript:void(0);\" [routerLink]=\"['/gente']\">Aquí</a></p> \n        </div>\n        <div *ngIf=\"!identity\">\n            <p>¿Ya tienes una cuenta? Entra por <a href=\"javascript:void(0);\" [routerLink]=\"['/login']\">Aquí</a></p> \n            <p>¿No estás registrado? Comienza registrandote en 20 segundos <a href=\"javascript:void(0);\" [routerLink]=\"['/registro']\">Aquí</a></p> \n        </div>\n    </div>\n</div>\n"
...
module.exports = "<div class=\"col-lg-6\">\n    <h1 class=\"h1-strong\">{{title}}</h1>\n    <div class=\"alert alert-success\" *ngIf=\"status=='success'\">\n        Loggin completado correctamente. Bienvenido {{identity.nick}}!\n        <!--<a [routerLink]=\"['/login']\">Identifícate!</a>-->\n    </div>\n     <div class=\"alert alert-danger\" *ngIf=\"status=='error'\">\n        El loggin no ha podido completarse, inténtalo de nuevo con otros datos.\n    </div>\n    <p class=\"_top20' top20\">\n        ¿Todavía no estás registrado? \n        <a [routerLink]=\"['/registro']\">Regístrate aquí</a>\n    </p>\n    <form #loginForm=\"ngForm\" (ngSubmit)=\"sendForm(loginForm)\" class=\"col-lg-10\" *ngIf=\"status!='success'\">\n        <p>\n            <label for=\"\">Correo electrónico</label>\n            <input autocomplete=\"off\" class=\"form-control\" required type=\"email\" name=\"email\" #email=\"ngModel\" [(ngModel)]=\"user.email\" pattern=\"[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,3}$\" required/>\n            <span *ngIf=\"!email.valid && email.touched\">\n                El Email es obligatorio\n            </span>\n        </p>  \n        <p>\n            <label for=\"\">Contraseña</label>\n            <input autocomplete=\"off\" class=\"form-control\" required type=\"password\" name=\"password\" #password=\"ngModel\" [(ngModel)]=\"user.password\" required/>\n            <span *ngIf=\"!password.valid && password.touched\">\n                La Contraseña es obligatoria\n            </span>\n        </p>          \n        <input type=\"submit\" value=\"{{title}}\" class=\"btn btn-success\" [disabled]=\"!loginForm.form.valid\"/>\n    </form>\n</div>\n"
    ...
    AddComponent.prototype.ngOnInit = function () {
        ...
        this.socket.on('refreshChat', function (data) {
            ...
            if ("#text")
                $("#text").focus();
            //scroll abajo        
            // document.getElementById("panel").scrollIntoView(false);
            var panel = document.getElementById("panel");
            panel.scrollTop = panel.scrollHeight;
        });
    };
...
var PublicationService = /** @class */ (function () {
    ...
    PublicationService.prototype.deletePublication = function (token, id) {
        console.log("El servicio el id q envia es el ---> " + id);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpHeaders */]().set('Content-Type', 'application/json').set('Authorization', token);
...
var TimelineComponent = /** @class */ (function () {
    ...
    TimelineComponent.prototype.getPublications = function (page, adding) {
        ...
        this._publicationService.getPublications(this.token, page).subscribe(function (response) {
            ...
            if (!adding) {
                _this.publications = response.publications;
                console.log('getPublications invocando a la pagina ---> ' + page);
            }
            else {
                var arrayA = _this.publications;
                var arrayB = response.publications;
